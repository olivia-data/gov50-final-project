...
What effects, if any, does party alignment have on whether or not Americans support voting rights for people convicted of felonies? My hypothesis is that Democrats will be more likely than Republicans or Independents to support allowing people convicted of felonies to vote after serving their sentence. However, I am not sure if a correlation between supporting voting rights and being a Democrat would be causal, as factors such as race, income, and education would also strongly affect a person's support of expanding such voting rights. Voting restrictions often disproportionately impact people of color. Also, people from lower income areas as well as people of color are more likely to be targeted by the police and more likely not to have access to resources such as housing or therapy that might reduce a person's likelihood of being involved in crime. I believe that party alignment will be a greater factor in whether or not a person supports allowing people convicted of felonies to vote after serving their sentence, but 
...
```{r}
fit <- lm(VTPRIORITY_e_W87 ~ c(F_PARTY_FINAL + F_RACECMB + F_EDUCCAT + F_INC_TIER2), data = data)
...
```
The estimated coefficient on the prop is about 0.043. The p-value is very close to zero, which means that the test of whether party has an effect on opinions of whether or not people convicted of felonies should be allowed to vote after serving their sentence is significant even when accounting for other coefficients. Because of this multiple regression and the p-value calculated earlier, I believe that the relationship between party and opinion of felons' voting is likely a causal relationship.


Conclusion:

These results point to the conclusion that political party does have an effect on whether or not someone supports voting rights for people convicted of felonies. Democrats are the most likely to believe that people convicted of felonies should be able to vote after serving their sentence. Race also is a factor in support, with Black people being the most likely to support these voting rights, but the multiple regression leads to the conclusion that party is a significant factor in support even when controlling for race.

One limit with this experiment is its nature as a survey. People who self-report their identities and opinions may report incorrect information depending on what they think they should say rather than what they actually believe. While it might be difficult to fix such an error, future studies on this could always widen the sample size in order to accound for this error and to help represent the population better.
